        ...
        <div className="flex-1 min-h-0 overflow-y-auto pretty-scroll p-3">
          {!row ? (
            ...
            <div className="grid grid-cols-1 gap-3">
              <Field label="생산 대상 품번 (Id)" value={row.id} mono />
              <Field label="브랜드 (Brand)" value={row.brand} />
              <Field label="휴대폰 이름(EN)" value={row.name} />
              <Field label="휴대폰 이름(KR)" value={row.description} />
            </div>
          )}
        </div>
