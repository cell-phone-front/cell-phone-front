// src/components/table-modal/product.js
...
export default function ProductFullModal({ open, onClose, token }) {
  ...
  const filteredData = useMemo(() => {
    ...
    return data.filter((r) =>
      [r.id, r.brand, r.name, r.description]
        .map((v) => String(v ?? ""))
        .join(" ")
        .toLowerCase()
        .includes(q),
            ...
            <div className="min-w-0 flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-0.5 text-[12px] text-slate-500 truncate">
                  검색은 품번/브랜드/이름(EN/KR) 기준으로 동작합니다.
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="relative w-[380px]">
                ...
                <input
                  ...
                  placeholder="검색 (품번/브랜드/이름 EN/KR)"
                  className="
